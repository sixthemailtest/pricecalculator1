...
function App() {
  ...
  const [extraHourRate, setExtraHourRate] = useState(savedShortStayPrices.extraHourRate.regular);
  ...
  // Load saved short stay prices from localStorage if available
  const savedShortStayPrices = localStorage.getItem('appShortStayPrices') 
    ? JSON.parse(localStorage.getItem('appShortStayPrices')) 
    : defaultShortStayPrices;
  
  const [shortStayPrices, setShortStayPrices] = useState(savedShortStayPrices);
  ...
  const [overnightExtraRate, setOvernightExtraRate] = useState(shortStayPrices.extraHourRate.regular);
  ...
  const resetForm = () => {
    ...
    setExtraHourRate(shortStayPrices.extraHourRate.regular);
    setIsSmoking(false);
